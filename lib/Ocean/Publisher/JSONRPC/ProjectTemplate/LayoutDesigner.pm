package Ocean::Publisher::JSONRPC::ProjectTemplate::LayoutDesigner;
...
use Ocean::ProjectTemplate::Layout::File::Handler::Cluster::PubSub;
...
use Ocean::Publisher::JSONRPC::ProjectTemplate::Layout::File::Starter;
use Ocean::Publisher::JSONRPC::ProjectTemplate::Layout::File::Stopper;
use Ocean::Publisher::JSONRPC::ProjectTemplate::Layout::File::Config;
use Ocean::Publisher::JSONRPC::ProjectTemplate::Layout::File::Context;
...
sub _design_root_layout {
    ...
    # $layout->add_file(
    #     Ocean::Publisher::JSONRPC::ProjectTemplate::Layout::File::Readme->new );
}
...
sub _design_config_layout {
    ...
    my $config_file = Ocean::Publisher::JSONRPC::ProjectTemplate::Layout::File::Config->new;
...
sub _design_bin_layout {
    ...
    my $starter_file = Ocean::Publisher::JSONRPC::ProjectTemplate::Layout::File::Starter->new;
    ...
    $bin_dir->add_file(
        Ocean::Publisher::JSONRPC::ProjectTemplate::Layout::File::Stopper->new );
}
...
sub _design_lib_layout {
    ...
    $self->add_module_file(
        ...
        Ocean::Publisher::JSONRPC::ProjectTemplate::Layout::File::Context->new );

    $self->add_module_file(
        $layout, $lib_dir, q{lib}, join('::', $context->get('handler_class'), 'PubSub'), 
        Ocean::ProjectTemplate::Layout::File::Handler::Cluster::PubSub->new );
