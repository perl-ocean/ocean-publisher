...
sub default_name { 'ocean-jsonrpc.yml'        }
...
server:
  ...
  backlog: 1024
  timeout: 300
  pid_file: __path_to(<: $layout.relative_path_for('run_dir') :>/ocean_jsonrpc.pid)__
...
log:
  ...
  formatter: color
  level: info
  filepath: __path_to(<: $layout.relative_path_for('log_dir') :>/ocean_jsonrpc.log)__
